<x-layout-app page-title="New colaborator" page-subtitle="Create a new colaborator for the Human Resources department">
    ...
    <div class="w-100 p-4">
        ...
        <form action="#" method="post">
            ...
            <div class="container-fluid">
                ...
                <div class="mt-3">
                    <a href="{{ route('rh.management.colaborators') }}" class="btn btn-outline-danger me-3">Cancel</a>
